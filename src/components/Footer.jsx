        ...
        <div className="flex items-center justify-center">
          ...
          >
            ...
            <g transform="translate(256,256)">
              <circle r="180" fill="none" stroke="#000000" strokeWidth="6" />
          ...
          <span className="text-2xl font-extralight font-serif">
            <span className="text-blue-500">T</span>a
            <span className="text-yellow-500">r</span>o
